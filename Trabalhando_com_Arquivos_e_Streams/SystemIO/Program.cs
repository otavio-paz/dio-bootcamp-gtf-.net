...
WriteLine("Digite enter para finalizar... "); //para o terminal nao fechar
ReadLine();

static string LimparNome(string nome)
{
    foreach (var @char in Path.GetInvalidFileNameChars()) //verifica caracteres invalidos e substitui
    {
